...
public class HttpCookieOAuth2AuthorizationRequestRepository implements AuthorizationRequestRepository<OAuth2AuthorizationRequest> {
	 ...
	 */
	private int defaultShortLivedMillis = 120000; // Two minutes
	
	private int cookieExpirySecs;
	
	public HttpCookieOAuth2AuthorizationRequestRepository(int shortLivedMillis) {

		cookieExpirySecs = shortLivedMillis <= 0 ? this.defaultShortLivedMillis / 1000 : shortLivedMillis / 1000;
	}
