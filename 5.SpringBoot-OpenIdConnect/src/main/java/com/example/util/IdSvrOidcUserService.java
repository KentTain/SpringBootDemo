...
public class IdSvrOidcUserService implements OAuth2UserService<OidcUserRequest, OidcUser> {
	private Logger logger = LoggerFactory.getLogger(IdSvrOidcUserService.class);
	...
	public OidcUser loadUser(OidcUserRequest userRequest) throws OAuth2AuthenticationException {
		...
		IdSvrOidcUser user = new IdSvrOidcUser(authorities, userRequest.getIdToken(), userInfo);
		user.setId(userId);
