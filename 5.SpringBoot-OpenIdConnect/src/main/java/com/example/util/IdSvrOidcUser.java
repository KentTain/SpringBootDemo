...
public class IdSvrOidcUser extends DefaultOAuth2User implements OidcUser {
	/**
	 ...
	 */
	public IdSvrOidcUser(Collection<? extends GrantedAuthority> authorities, OidcIdToken idToken) {
	 ...
	 */
	public IdSvrOidcUser(Collection<? extends GrantedAuthority> authorities, OidcIdToken idToken, String nameAttributeKey) {
	 ...
	 */
	public IdSvrOidcUser(Collection<? extends GrantedAuthority> authorities, OidcIdToken idToken, OidcUserInfo userInfo) {
