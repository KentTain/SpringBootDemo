...
public class IdSrvHttpCookieAuthorizationRequestRepository
	...
	private int _cookieExpirySecs;
	
	public IdSrvHttpCookieAuthorizationRequestRepository(int cookieExpirySecs) {

		_cookieExpirySecs = cookieExpirySecs;
	}
